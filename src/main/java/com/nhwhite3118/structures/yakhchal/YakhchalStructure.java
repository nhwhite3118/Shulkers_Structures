...
public class YakhchalStructure extends Structure<NoFeatureConfig> {

    public YakhchalStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
        super(config);
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ) {
        ...
        int maxDistance = ShulkersStructures.Config.yakhchalSpawnrate.get();
    ...
    public String getStructureName() {
        return ShulkersStructures.MODID + ":yakhchal";
    }
    ...
    public Structure.IStartFactory getStartFactory() {
        return YakhchalStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
            ...
            YakhchalPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
            ...
            // where it is.
            ShulkersStructures.LOGGER.log(Level.DEBUG, "Yakhchal at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
