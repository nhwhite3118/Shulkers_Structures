...
public class TowerPieces {
    private static final ResourceLocation ENTRANCE = new ResourceLocation(ShulkersStructures.MODID + ":tower_entrance");
    private static final ResourceLocation ROOF = new ResourceLocation(ShulkersStructures.MODID + ":tower_roof");
    private static final ResourceLocation FOUNDATION = new ResourceLocation(ShulkersStructures.MODID + ":tower_foundation");
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
        ...
        pieceList.add(new TowerPieces.Piece(templateManager, ENTRANCE, pos, rotation));
        pieceList.add(new TowerPieces.Piece(templateManager, ROOF, pos, rotation));
        pieceList.add(new TowerPieces.Piece(templateManager, FOUNDATION, pos, rotation));
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(GenerationInformation generationInfo, ResourceLocation resourceLocationIn) {
            super(Structures.FOR_REGISTERING_TOWER, 0);
            this.resourceLocation = resourceLocationIn;
            BlockPos blockpos = TowerPieces.OFFSET.get(resourceLocation);
        ...
        public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            super(Structures.FOR_REGISTERING_TOWER, tagCompound);
...
//                ChunkPos chunkPos) {
//            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE);
//            BlockPos blockpos = TowerPieces.OFFSET.get(this.resourceLocation);
